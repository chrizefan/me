...
COMPANY_PROFILES = {
    ...
    "Anthropic": {
        "custom_intro": "Over the past five years, I have designed and deployed production-grade agentic AI systems at scale. I led development of PSP's Virtual Analyst Platform—production agentic AI used in analyst and PM research workflows—and own the full ML infrastructure stack from LLM integrations to advanced retrieval systems. At Anthropic, I see the opportunity to apply this expertise to advance AI infrastructure at the frontier.",
        "project_highlight": "The highlight of my work has been architecting and deploying agentic AI systems that institutional teams trust and use daily. I built the underlying infrastructure: custom SDK with vector search retrieval, multi-step reasoning, function calling, and integration of multiple LLM providers (OpenAI, Gemini, Databricks). I designed systems used in production research workflows with mission-critical use cases, ensuring reliability and interpretability in every deployment. I have hands-on expertise in AI infrastructure, LLM optimization, and building systems that users trust.",
    ...
    "xAI": {
        ...
        "project_highlight": "The highlight of my work has been architecting production agentic AI systems with transparency and reliability. I built custom AI infrastructure: SDK with advanced retrieval, multi-step reasoning, function calling, and integration of multiple LLM providers. I designed systems used in production research workflows with mission-critical use cases, ensuring reliability and interpretability in every deployment. I have hands-on expertise in AI infrastructure, LLM optimization, and building systems that users trust.",
    ...
    "Generic": {
        "custom_intro": "Over the past five years at PSP Investments, I have designed, built, and deployed production-grade infrastructure systems that serve institutional operations. I bring deep expertise in building scalable systems from prototype to live production.",
        "project_highlight": "The highlight of my work has been leading end-to-end infrastructure projects including designing comprehensive data pipelines, building distributed systems, and architecting platforms used in production research workflows. I have hands-on expertise in the full stack: backend architecture, system design, integration of complex tools and systems, custom interface development, and production deployment.",
